...
const ftrBlock = document.querySelector(".featured #ftrBlock");
const docBlock = document.querySelector(".featured #docBlock");
const features = document.querySelector(".featured .features");
const featured = document.querySelector(".featured a");
